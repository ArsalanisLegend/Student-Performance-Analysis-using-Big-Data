...
ls = ['gender','Relation','Topic','SectionID','GradeID','NationalITy','Class','StageID','Semester',
...
# dimensionality reduction with RandomForest
...
ls = ['VisITedResources','raisedhands','AnnouncementsView','StudentAbsenceDays_Above-7',
      'StudentAbsenceDays_Under-7','Discussion']
...
for name, model in models:
    kfold = KFold(n_splits=10, shuffle=True, random_state=7)   # ✅ fixed
